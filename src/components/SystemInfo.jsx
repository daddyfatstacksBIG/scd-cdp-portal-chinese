    ...
    return (
      <React.Fragment>
        <div className="col col-2-m active-network-section">
          <p className="typo-c align-center">
            <span
              className={
            ...
            {this.props.network.network === "main"
              ? "Main Ethereum"
              : capitalize(this.props.network.network) + " Test"}{" "}
            网络
          </p>
        </div>
        <div className="col col-2-m info-section">
          <div className="price-info">
            ...
            <div className="value">
              {this.props.system.pip.val && this.props.system.pip.val.gt(0) ? (
                <span>
                  <span>{printNumber(this.props.system.pip.val)}</span>
            ...
            <div className="value">
              {this.props.system.tub.per.gte(0) ? (
                <span>
                  <span>{printNumber(this.props.system.tub.per)}</span>
            ...
            <div className="value">
              {this.props.system.vox.par.gte(0) ? (
                <span>
                  <span>{printNumber(this.props.system.vox.par)}</span>
                  <span className="unit">USD</span>
                </span>
              ) : (
                <span>加载中...</span>
            ...
            <div className="value">
              {this.props.system.pep.val && this.props.system.pep.val.gt(0) ? (
                <span>
                  <span>{printNumber(this.props.system.pep.val)}</span>
                  <span className="unit">USD</span>
                </span>
              ) : (
                <span>Loading...</span>
          ...
          <div className="cdp-info">
            ...
            <div className="value">
              {this.props.system.gem.tubBalance.gte(0) &&
              this.props.system.pip.val.gte(0) &&
              this.props.system.dai.totalSupply.gte(0) &&
              this.props.system.vox.par.gte(0) ? (
                <span>
                  {printNumber(
                    this.props.system.dai.totalSupply.eq(0)
                      ...
                      : wdiv(
                          wmul(
                            this.props.system.gem.tubBalance,
                            this.props.system.pip.val
                          ),
                          wmul(
                            this.props.system.dai.totalSupply,
            ...
            <div className="value">
              {this.props.system.dai.totalSupply &&
              this.props.system.dai.totalSupply.gt(0) ? (
                <span>
                  <span>{printNumber(this.props.system.dai.totalSupply)}</span>
                  <span className="unit">&#36;</span>
                </span>
              ) : (
                <span>加载中...</span>
            ...
            {this.props.network.network === "main" && (
              <h3 className="typo-c">
                <a
                  href="https://mkr.tools/cdps/funded"
                  target="_blank"
