      ...
      <div className="landing">
        <div className="landing-body">
          ...
          <Slider {...settings} className="landing-slider">
            ...
            <div>
              <div className="info-slide">
                <h1>
                  01.<span className="line"></span>概念
                </h1>
                <h2 className="sm">什么是质押债仓（CDP）?</h2>
                <p>
                  你可以通过质押债仓(CDP) 存入质押品 (目前支持 ETH)，借
                  Sai。之后偿还 Sai，取回质押品。
                </p>
              </div>
            </div>
            <div>
              <div className="info-slide">
                <h1>
                  02.<span className="line"></span>好处
                </h1>
                <h2>使用质押债仓对我有什么好处?</h2>
                <p>
                  你可以在不放弃质押品收益权的同时，获得 Sai 作为流动资金
                  (只要有足够的抵押品支撑生成的 Sai)。当使用 ETH
                  作为抵押品时，抵押品的价值需要保持在生成 Sai 数量的1.5倍。
                </p>
              </div>
            </div>
            <div>
              <div className="info-slide">
                <h1>
                  03.<span className="line"></span>开始
                </h1>
                <h2>如何开始?</h2>
                <p>
                  <i>（网页端点击右上角连接钱包，手机端下滑后点击连接）</i>{" "}
                  <br />
                  你可以选择要存入 CDP 内的 ETH 数量，然后生成对应的稳定币
                  Sai，便可以任意使用。当你不需要流动性后，可以随时偿还 Sai
                  和稳定费用，取回存入的抵押品。
                </p>
              </div>
            </div>
            <div>
              <div className="info-slide">
                <h1>
                  04.<span className="line"></span>风险
                </h1>
                <h2>生成 CDP 有风险吗?</h2>
                <p>
                  {" "}
                  只要保持你的 CDP 中，ETH 的价值高于 SAI
                  的150%，CDP就不会被清算。如果质押率接近
                  150%，你可以追加质押品，或者偿还部分
                  Sai。如果质押品的价值下降到 150% 以下，CDP
                  会被清算。这意味着，系统会出售你的质押品，向市场回购你生成出的
                  Sai 数量。剩余的质押品会返回你的 CDP
                  中供你取回。有关风险，请查看 <Link to="/terms">服务条款</Link>
                  。
                </p>
              </div>
            </div>
            <div>
              <div className="info-slide">
                <h1>
                  05.<span className="line"></span>成本
                </h1>
                <h2>使用中会有费用吗？</h2>
                <p>
                  {this.state.stabilityFee
                    ? `生成稳定币 Sai 会有${this.state.stabilityFee}%的年化费用，你可以用 MKR 或者 SAI 支付费用。`
                    : ""}
                  如果你的 CDP 被清算，你的质押品会被扣除13%的罚金。
                </p>
              </div>
            </div>
          </Slider>
          ...
          <div className="getting-started">
            ...
            <p>
              {" "}
              授权以下的四个钱包之一，自动连接到CDP平台。了解这些钱包的更多信息，点击下方的链接。如果你是高级用户，也可以使用
              MakerDAO 的命令符面板使用CDP。
            </p>
            <p className="align-center">
            ...
            <ul>
              <li>
                <a href="https://metamask.io/">
                  <img src={metamaskLogo} alt="Get MetaMask" />
                  <div>获得 MetaMask</div>
                </a>
              </li>
              <li>
                <a href="https://www.parity.io/">
                  <img src={parityLogo} alt="Get Parity" />
                  <div>获得 Parity</div>
                </a>
              </li>
              <li>
                <a href="https://www.ledgerwallet.com/products/ledger-nano-s">
                  <img src={ledgerNanoLogo} alt="Get Ledger Nano S" />
                  <div>获得 Ledger Nano S</div>
                </a>
              </li>
              <li>
                <a href="https://trezor.io/">
                  <img src={trezorLogo} alt="Get Trezor" />
                  <div>获得 Trezor</div>
                </a>
              </li>
            </ul>
